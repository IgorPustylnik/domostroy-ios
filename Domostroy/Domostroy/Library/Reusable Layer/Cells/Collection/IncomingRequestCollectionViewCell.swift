//
//  IncomingRequestCollectionViewCell.swift
//  Domostroy
//
...
final class IncomingRequestCollectionViewCell: UICollectionViewCell, HighlightableScaleView {
...
extension IncomingRequestCollectionViewCell: ConfigurableItem {
...
private extension IncomingRequestCollectionViewCell {
...
extension IncomingRequestCollectionViewCell.ViewModel: Equatable {
    static func == (
        lhs: IncomingRequestCollectionViewCell.ViewModel,
        rhs: IncomingRequestCollectionViewCell.ViewModel
    ) -> Bool {
...
extension IncomingRequestCollectionViewCell.ViewModel.Action: Equatable {
    static func == (
        lhs: IncomingRequestCollectionViewCell.ViewModel.Action,
        rhs: IncomingRequestCollectionViewCell.ViewModel.Action
    ) -> Bool {
