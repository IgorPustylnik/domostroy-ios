...
struct RussianPhoneValidator: TextValidator {
    func validate(_ text: String?) -> ValidationResult {
        ...
        let prefix = String(text.dropFirst().prefix(3))
        guard Self.russianCellPhonePrefixes.contains(prefix) else {
            return (false, L10n.Localizable.ValidationError.phone)
        }
    ...
    private static let russianCellPhonePrefixes: Set<String> = [
