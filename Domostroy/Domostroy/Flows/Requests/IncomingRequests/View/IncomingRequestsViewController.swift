//
//  IncomingRequestsViewController.swift
//  Domostroy
//
...
final class IncomingRequestsViewController: UIViewController {
    ...
    var output: IncomingRequestsViewOutput?
...
// MARK: - IncomingRequestsViewInput

extension IncomingRequestsViewController: IncomingRequestsViewInput {
    ...
    func fillFirstPage(with viewModels: [IncomingRequestCollectionViewCell.ViewModel]) {
        requestsGenerators = viewModels.map {
            let generator = IncomingRequestCellGenerator(
                uniqueId: UUID(),
                with: $0,
                registerType: .class
            )
...
private extension IncomingRequestsViewController {
