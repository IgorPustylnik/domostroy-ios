//
//  OutgoingRequestsModuleConfigurator.swift
//  Domostroy
//
...
final class OutgoingRequestsModuleConfigurator {

    func configure() -> (
       OutgoingRequestsViewController,
       OutgoingRequestsModuleOutput
    ) {
        let view = OutgoingRequestsViewController()
        let presenter = OutgoingRequestsPresenter()
